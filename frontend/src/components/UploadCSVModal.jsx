    ...
    <div className="ds-overlay" onClick={(e) => e.target === e.currentTarget && onClose?.()}>
      <div className="ds-modal">
        ...
        <div className="ds-modal-body" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          >
            <div style={{ width: 44, height: 44, borderRadius: 10, background: '#EEF1FD', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#8A9FE8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div>
              <p style={{ fontSize: '0.875rem', fontWeight: 600, color: '#111827', margin: '0 0 4px' }}>
                {selectedFile ? `✓ ${selectedFile.name}` : 'Drop CSV here or click to browse'}
              </p>
              <p style={{ fontSize: '0.78rem', color: '#9CA3AF', margin: 0 }}>
                {selectedFile ? `${(selectedFile.size / 1024).toFixed(1)} KB` : 'Accepts .csv files only'}
              </p>
            </div>
            <input
              id="csv-file-input"
          ...
          <div style={{ background: '#F9FAFB', border: '1px solid #E9EBF0', borderRadius: 10, padding: '14px 16px' }}>
            ...
            <code style={{ display: 'block', background: '#EEF1FD', borderRadius: 6, padding: '8px 12px', fontSize: '0.78rem', color: '#8A9FE8', fontFamily: 'monospace' }}>
